...
namespace Assets.Code.Scripts.Street.BezierCurve
{
    ...
    public class StreetCreator : MonoBehaviour
    {
        ...
        public void UpdateRoad()
        {
            ...
            int textureRepeat = Mathf.RoundToInt(tiling * points.Length * 0.05f);
            GetComponent<MeshRenderer>().sharedMaterial.SetVector("_Tiling", new Vector2(1, textureRepeat));
        }

        public Mesh CreateRoadMesh(Vector3[] points, bool isClosed)
        {
            ...
            for(int i = 0; i < points.Length; i++)
            {
                ...
                verts[vertIndex + 1] = points[i] + right * roadWidth * 0.5f;
